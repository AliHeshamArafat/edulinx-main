...
export default function CategoryCard({ category, selected, onClick }: CategoryCardProps) {
  ...
  return (
    ...
    >
      ...
      {/* Category Name */}
      <h3 className={`font-medium ${selected ? "text-primary" : "text-gray-800"} group-hover:text-primary transition-colors`}>
